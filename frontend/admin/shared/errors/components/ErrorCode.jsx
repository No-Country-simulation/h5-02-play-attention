    ...
    <div className='mb-6 flex justify-center'>
      <div className='relative'>
        <div className='text-[180px] font-black text-white leading-none'>
          ...
          <span className='bg-gradient-to-r from-[#00ff99] to-[#00e187] bg-clip-text text-transparent'>
            {code}
          </span>
        </div>
        <div className='absolute -inset-4 opacity-50 blur-lg rounded-full bg-gradient-to-r from-[#00ff9920] to-[#00e18720]'></div>
      </div>
    </div>
  );
};
