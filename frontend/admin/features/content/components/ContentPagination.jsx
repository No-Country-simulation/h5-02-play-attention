...
/**
 * Componente de paginación para la lista de contenido
...
const ContentPagination = ({
  ...
  return (
    <div className='flex flex-col lg:flex-row justify-between items-center gap-4 mt-6 mb-8'>
      <div className='text-xs lg:text-sm text-gray-700 text-center lg:text-left'>
        ...
        de <span className='font-medium'>{totalCount}</span> contenidos
      </div>
